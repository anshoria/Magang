    ...
    <form action="" method="post">
        <div class="container" style="margin-top: 30px;">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="NIP" placeholder="Masukkan NIP Pegawai" name="NIP" required maxlength="18">
            </div>
            <div class="mb-3">
                <label for="NIK" class="form-label">NIK</label>
                <input type="number" class="form-control" id="NIK" placeholder="Masukkan NIK Pegawai" name="NIK" required maxlength="16">
            </div>
