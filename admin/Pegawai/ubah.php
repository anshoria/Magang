    ...
    <form action="" method="post">
        <div class="container" style="margin-top: 50px;">
            ...
            <div class="mb-3">
                ...
                <input value="<?php echo $kry["NIP"]; ?>" type="number" class="form-control" id="NIP" name="NIP" required maxlength="18">
            </div>
            <div class="mb-3">
                <label for="NIK" class="form-label">NIK</label>
                <input value="<?php echo $kry["NIK"]; ?>" type="number" class="form-control" id="NIK" name="NIK" required maxlength="18">
            </div>
