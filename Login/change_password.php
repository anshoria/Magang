		...
		<div class="container d-flex justify-content-center align-items-center" style="min-height: 100vh">
			<form class="border shadow p-3 rounded bg-light" action="change_pass.php" method="post" style="width: 450px;">
				...
				<div class="mb-1">
					...
					<input class="form-control" type="password" name="pl" placeholder="Password Lama">
					<br>
				</div>
				<div class="mb-1">
					<label class="form-label text-dark">Password Baru</label>
					<input class="form-control" type="password" name="pb" placeholder="Password Baru">
					<br>
				</div>
				<div class="mb-1">
					<label class="form-label text-dark">Konfirmasi Password Baru</label>
					<input class="form-control" type="password" name="k_pb" placeholder="Konfirmasi Password Baru">
					<br>
				</div>
